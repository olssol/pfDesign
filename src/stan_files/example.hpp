...
namespace model_example_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_example");
    reader.add_event(24, 22, "end", "model_example");
    return reader;
}

#include <meta_header.hpp>
 class model_example : public prob_grad {
private:
        int N;
        std::vector<double> Y;
public:
    model_example(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_example_namespace::model_example";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_example_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_example_namespace::model_example stan_model;
